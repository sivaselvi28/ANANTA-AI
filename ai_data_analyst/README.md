...
The AI Data Analyst Agent bridges the gap between natural language and database analytics. Type a question like *"Which department has the highest average salary?"* and the agent:
